  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      <div className="w-full max-w-md mx-auto flex flex-col items-center justify-center">
        ...
        <h1 className="text-2xl font-semibold text-center mb-2">Verify through email<br />address or phone number</h1>
        <div className="text-center text-xs text-gray-600 mb-6">
          We&apos;ve sent a verification code to <span className="text-[#006CE4] underline">{email}</span> and <span className="text-[#006CE4] underline">{phone}</span>. Please enter this code to continue.
        </div>
