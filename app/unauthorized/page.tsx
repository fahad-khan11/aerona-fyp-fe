...
import { Home, Lock, Shield, User } from "lucide-react"
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center items-center space-x-6 mb-8">
              <div className="animate-bounce" style={{ animationDelay: "0s", animationDuration: "2s" }}>
                <Shield className="w-12 h-12 text-[#00b4d7] drop-shadow-lg" />
              </div>
              <div className="animate-bounce" style={{ animationDelay: "0.5s", animationDuration: "2s" }}>
                <Lock className="w-16 h-16 text-[#00b4d7] drop-shadow-lg" />
              </div>
              <div className="animate-bounce" style={{ animationDelay: "1s", animationDuration: "2s" }}>
                <User className="w-12 h-12 text-[#00b4d7] drop-shadow-lg" />
              </div>
            </div>

            {/* 401 with neon effect using brand colors */}
            <div className="relative">
              ...
              <div className="absolute inset-0 text-9xl font-black text-[#00b4d7]/20 blur-sm">401</div>
              {/* Additional glow layer */}
              <div className="absolute inset-0 text-9xl font-black text-[#00b4d7]/10 blur-lg">401</div>
            </div>

            {/* Error message */}
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-white drop-shadow-lg">Access Denied</h2>
